...
| [Umami](package-guides/umami_reference.md) | v2.x/v3.x | ~1,250 | HTTP API for the privacy-focused web analytics platform — stats, reports, events, and ingestion (with `umami-analytics` Python client) |
